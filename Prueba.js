...
function verCarrito() {
    ...
    const btnFinalizar = document.querySelector('.boton-finalizar');
    ...
    if (productosEnCarrito.length === 0) {
        ...
        btnFinalizar.classList.add('boton-deshabilitado');
    } else {
        let total = 0;
        btnFinalizar.classList.remove('boton-deshabilitado');
